...
@Tag(
    ...
    description = "Medical supplies, medication stock and pharmacy prescription fulfillment")
public class InventoryPharmacyController {
  ...
  public ResponseEntity<SupplyItem> upsertSupply(@Valid @RequestBody SupplyRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(inventoryPharmacyService.upsertSupply(request));
  }
  ...
  public ResponseEntity<MedicationStock> upsertMedication(
      @Valid @RequestBody MedicationRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(inventoryPharmacyService.upsertMedication(request));
  }
  ...
  public ResponseEntity<PharmacyPrescription> receivePrescription(
      @Valid @RequestBody PharmacyPrescriptionRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(inventoryPharmacyService.receivePrescription(request));
  }
  ...
  public ResponseEntity<MedicationCharge> createCharge(
      @Valid @RequestBody MedicationChargeRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(inventoryPharmacyService.createCharge(request));
  }
  ...
  @GetMapping("/medications/{id}/movements")
  public java.util.List<java.util.Map<String, Object>> movements(@PathVariable UUID id) {
    return inventoryPharmacyService.movements(id);
  }

  @GetMapping("/supplies/{id}/movements")
  public java.util.List<java.util.Map<String, Object>> supplyMovements(@PathVariable UUID id) {
    return inventoryPharmacyService.supplyMovements(id);
  }
}
