...
public final class StaffDashboardModels {
    ...
    public record ClinicalRound(UUID id, UUID staffId, UUID patientId, String unit, String notes, String status, Instant updatedAt) {}
    public record PatientChartSummary(UUID id, UUID patientId, String summary, String riskLevel, Instant updatedAt) {}
    public record StaffTask(UUID id, UUID assigneeId, UUID patientId, String title, String priority, String status, Instant updatedAt) {}
}
