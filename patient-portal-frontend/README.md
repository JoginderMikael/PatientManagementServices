...
Run the Phase 1 through Phase 3 gates before handing off changes:
...
handling, the minimal patient portal, staff registry/context, queue, appointment and
chart workflows, and basic accessibility checks.
