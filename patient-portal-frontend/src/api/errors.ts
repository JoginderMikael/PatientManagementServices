...
export function defaultErrorMessage(status: number): string {
  switch (status) {
    case 400:
      return "The request could not be accepted. Review the information and try again.";
    case 401:
    ...
    case 409:
      return "This information changed. Review the current state before continuing.";
    case 410:
      return "This information is no longer available.";
    case 422:
      return "Some information needs your attention.";
    case 502:
      return "A required downstream service is temporarily unavailable. Retry this operation using the same reference.";
    case 503:
