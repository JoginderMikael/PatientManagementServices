-- Local development data only. Production Flyway locations must exclude db/dev-migration.
INSERT INTO patient (id, mrn, name, email, address, date_of_birth, registered_date)
